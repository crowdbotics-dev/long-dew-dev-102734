"""
Django settings for long_dew_dev_102734 project.
...
ROOT_URLCONF = 'long_dew_dev_102734.urls'
...
WSGI_APPLICATION = 'long_dew_dev_102734.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "long_dew_dev_102734 API",
    "DESCRIPTION": "API documentation for long_dew_dev_102734 App",
    "VERSION": "v1",
}
